...
router.get('/employees_per_branch/:branchId', branchsCntrl.getEmployeePerBranch)
router.get('/machines_per_branch/:branchId', branchsCntrl.getMachinesPerBranch)
router.get('/businesses_per_branch/:branchId', branchsCntrl.getbusinessesPerBranch)
